...
你读到一段话，第一反应不是“总结一下”，而是：这跟我现在遇到的事有什么关系？作者这个判断我同不同意？如果明天就要用，它能变成哪一个动作？

很多 AI 阅读工具在这里会停住：概括、列要点、出金句。`reading-companion` 想往前多走半步。它让你的 agent 坐在本地阅读器旁边，陪你划线、追问、反驳、拆案例，把那些一闪而过的“我好像懂了”留下来。留下来的不只是聊天记录，还有卡片、划线日志和一份会慢慢长出来的阅读画像。

下次打开同一本书，或换一本新书，它不会假装第一次见你。它知道你常把理论翻成工作动作，知道你偏爱案例还是框架，也知道哪些解释你已经嫌太泛。书在本机，记录在本机，理解也从你的真实阅读动作里长出来。
